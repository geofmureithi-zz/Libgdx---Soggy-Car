...
public class Play_4 extends GameState {
    ...
    public Play_4(GameStateManager gsm) {
        super(gsm);
...
//      set up box2d cam
    ...
    public void update(float dt) {
        ...
        if(player.getBody().getPosition().y * B2DVars.PPM > tileMapHeight * tileSize - 500) {
            ...
            trafficgame.getNormalPrefs().putBoolean("Level5", true);
    ...
    private void createWalls() {
        ...
        try {
            tileMap = new TmxMapLoader().load("maps/enhanced_4.tmx");
        }
        catch(Exception e) {
