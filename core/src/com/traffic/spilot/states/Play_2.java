...
public class Play_2 extends GameState {
    ...
    public Play_2(GameStateManager gsm) {
        super(gsm);
...
//      set up box2d cam
    ...
    public void update(float dt) {
        ...
        if(player.getBody().getPosition().y * B2DVars.PPM > tileMapHeight * tileSize - 500) {
            ...
            trafficgame.getNormalPrefs().putBoolean("Level3", true);
    ...
    private void createWalls() {
        ...
        try {
            tileMap = new TmxMapLoader().load("maps/enhanced_2.tmx");
        }
        catch(Exception e) {
