...
public class Play_3 extends GameState {
    ...
    public Play_3(GameStateManager gsm) {
        super(gsm);
...
//      set up box2d cam
    ...
    public void update(float dt) {
        ...
        if(player.getBody().getPosition().y * B2DVars.PPM > tileMapHeight * tileSize - 500) {
            ...
            trafficgame.getNormalPrefs().putBoolean("Level4", true);
            trafficgame.getNormalPrefs().flush();
            Gameover.nextLevel = 4;
    ...
    private void createWalls() {
        ...
        try {
            tileMap = new TmxMapLoader().load("maps/enhanced_3.tmx");
        }
        catch(Exception e) {
